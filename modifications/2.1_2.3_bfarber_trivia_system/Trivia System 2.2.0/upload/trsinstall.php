...
function do_intro()
{
	...
	$template->print_top('Установка Викторины для IPB 2.2 от bfarber & Sannis');
	
	$template->contents .= "<table width='100%' border='0' cellpadding='0' cellspacing='0' align='center' class='mainborder'>
							<tr>
							 <td width='100%'><h3>Установка Викторины для IPB 2.2</h3>
							  <br />
...
class template {
	...
	function output()
	{
		...
		echo "   
				 ...
				 <br><br><br><br><center><span id='copy'>Установщик Викторины от <a href='http://ipbmods.net'>bfarber</a>, версия для IP.Board 2.2.x от <a href='http://ibpower.ru/index.php?showuser=33'>Sannis</a></span></center>
				 </td></tr></table>
				 </body>
				 </html>";
		exit();
	...
	function print_top($title="", $meta="")
	{
		...
		$this->contents = "<html>
				{$meta}
		          <head><title>Викторина 2.2.0 :: $title </title>
		          <style type='text/css'>
